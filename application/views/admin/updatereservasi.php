            ...
            <div class="box-body">
              ...
              <table>
                ...
                <tr>
                  ...
                  <td>&nbsp;&nbsp; : </td>
                  <td>&nbsp;&nbsp; <?php echo $dr->instansi ?> <input type="hidden" id="id_transaksi" name="id_transaksi" value="<?php echo $dr->id_transaksi ?>" size="5">  <input type="hidden" id="ins" name="ins" value="<?php echo $dr->instansi ?>" size="5"> </td>
                  <td width="30%"> </td>
              ...
              <table id="exampleupdate" class="table table-bordered table-striped">
                ...
                <tr id="row-<?= $dt->id_transaksi_detil ?>">
                  ...
                  <td align="center">
                    <?php if($dt->status_order == "Reserved" || $dt->status_order == "Check In" || $dt->status_order == "Check Out" || $dt->status_order == "New Reservation"){ ?>
              ...
              <?php
                foreach ($detil_reservasi as $dtx) {
                  if($dt->status_order == "Reserved" || $dt->status_order == "Check In" || $dt->status_order == "Check Out" || $dt->status_order == "New Reservation"){
              ?>
