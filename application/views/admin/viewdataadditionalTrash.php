<?php include "Header.php"; ?>
        ...
        <section class="col-lg-12">
          ...
          <div class="box box-primary">
            <div class="box-header">
              ...
              <h3 class="box-title">Master Data Additional In Bin</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  <?php
                    $no = 1;
                    foreach ($jenis_additional_bin as $jk) {
                ...
                <tr id="row-<?= $jk->id_additional ?>">
                  ...
                  <td align="center">
                    <button class="btn btn-warning btn-sm" onClick="RestoreData(<?= $jk->id_additional ?>)"><i class="glyphicon glyphicon-repeat"></i>&nbsp; Restore</button>
                    <button class="btn btn-danger btn-sm" onClick="deleteData(<?= $jk->id_additional ?>)"><i class="glyphicon glyphicon-remove"></i>&nbsp; Delete</button>
                  </td>
                </tr>
                <?php } ?>
                </tbody>
  ...
  <script>
    function deleteData(id) {
        ...
        function() {
            $.get('<?php echo base_url('AdditionalController/hapus/'); ?>', {id:id}, function(data) {
              if (data == 'succeed') {
                  $('#row-' + id).remove();
  ...
  <script>
    function RestoreData(id) {
        ...
        function() {
            $.get('<?php echo base_url('AdditionalController/restoredelete/'); ?>', {id:id}, function(data) {
              if (data == 'succeed') {
                  $('#row-' + id).remove();
