        ...
        <section class="col-lg-12">
          ...
          <div class="box box-primary">
            <div class="box-header">
              ...
              <h3 class="box-title">Add Master Data Tarif</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <form role="form" action="<?php echo base_url(). 'TarifController/tambah_aksi'; ?>" method="post" onsubmit="return validasi();" enctype="multipart/form-data">
                <!-- text input -->
                <?php echo $this->session->userdata("validasidata"); ?>
                <div class="box-body col-lg-6">
                  <div class="form-group">
                      <label>Jenis Tamu</label>
                      <select id="event" name="idjenistamu" class="form-control select2" style="width: 100%;" required>
                        <option selected="selected" value="">Pilih Jenis Tamu</option>
                ...
                <div class="box-body col-lg-6">
                  <div class="form-group">
                      ...
                      <select id="field-check" name="idjenistarif" class="form-control select2" style="width: 100%;" required disabled>
