        ...
        <section class="col-lg-12">
          ...
          <div class="box box-primary">
            <div class="box-header">
              ...
              <h3 class="box-title">Check Out Tamu</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <form role="form" action="<?php echo base_url('dashboard/admin/data/konfirmasi/checkout'); ?>" method="get" enctype="multipart/form-data">
                ...
                <div class="col-lg-2">
                  <div class="form-group">
                    ...
                    <a href="<?php echo base_url('dashboard/admin/data/konfirmasi/checkout'); ?>"><button class="btn btn-success" style="margin-top:24px;"><i class="glyphicon glyphicon-refresh"></i>&nbsp; Refresh</button></a>
                  </div>
               </div>
              </form>
              </div>
              ...
              if($cc != "")
              {
                ...
                ?>
                  ...
                  <td align="center">
                    <?php
                      if($dr->status_order == "Check In")
                      {
                    ?>
                        <a href="<?php echo base_url('dashboard/admin/data/konfirmasi/checkout/detail/'.$dr->id_transaksi); ?>"><button class="btn btn-success btn-sm" ><i class="glyphicon glyphicon-list-alt"></i>&nbsp; Detail</button></a>&nbsp;&nbsp;
                    <?php
                      }else {
                    ?>
