                        ...
                        <td align="center">
                          <table border="0">
                            <tr>
                              ...
                              <td width="5%"> </td>
                              <?php
                              if($r->status_order != "Check In" && $r->status_order != "Check Out")
                              {
                              ?>
                              ...
                              <td><button class="btn btn-danger btn-sm" onClick="deleteData(<?= $r->id_transaksi ?>)"><i class="glyphicon glyphicon-remove"></i>&nbsp; Cancel</button></td>
                              <?php }else { ?>
                              <td width="64%"> </td>
                              <?php } ?>
                            </tr>
