                      ...
                      <legend class="scheduler-border">Additional</legend>
                        <fieldset class="scheduler-border">
                          <legend class="scheduler-border">Additional Ruang Makan</legend>
                            <table border='0' style='margin-bottom:15px;' width='100%' id='dynamicInput'>
                              <tr>
                                <td width='85%'>
                                  <label>Ruang Makan</label>
                                    <div class="input-group date">
                                      ...
                                      <select id="idrumakan" name="ruangpertemuan[]" class="form-control field-check-form1 target1" style="width: 100%;" disabled>
                                        <option selected="selected" disabled="disabled">Pilih Ruang Makan</option>
                                ...
                                <td> <input type='button' class='btn btn-sm btn-primary' style='margin-top:25px; margin-left:10px;' value='Add' onClick="addInput('dynamicInput');"> </td>
                              </tr>
                            </table>
                        </fieldset >

                        <fieldset class="scheduler-border">
                          <legend class="scheduler-border">Additional Ruang Pertemuan</legend>
                            <table border='0' style='margin-bottom:15px;' width='100%' id='dynamicInput2'>
                              <tr>
                                <td width='85%'>
                                  ...
                                  <div class="input-group date">
                                    ...
                                    <select name="ruangpertemuan[]" class="form-control field-check-form1 target2 idruangpertemuan" style="width: 100%;" disabled>
                                      <option selected="selected" disabled="disabled">Pilih Ruang Pertemuan</option>
                                ...
                                <td> <input type='button' class='btn btn-sm btn-primary' style='margin-top:25px; margin-left:10px;' value='Add' onClick="addInput2('dynamicInput2');"> </td>
                              </tr>
                            </table>
                        </fieldset >
                        ...
                        <fieldset class="scheduler-border">
                          <legend class="scheduler-border">Additional Fasilitas</legend>
                            <table border='0' style='margin-bottom:15px;' width='100%' id='dynamicInput3'>
                              <tr>
                                <td width='85%'>
                                  ...
                                  <div class="input-group date">
                                    ...
                                    <select id="idadditional" name="fasilitasplus[]" class="form-control field-check-form1 target3" style="width: 100%;" disabled>
                                      <option selected="selected" disabled="disabled">Pilih Tambahan Fasilitas</option>
                                ...
                                <td> <input type='button' class='btn btn-sm btn-primary' style='margin-top:25px; margin-left:10px;' value='Add' onClick="addInput3('dynamicInput3');"> </td>
                              </tr>
                            </table>
                        </fieldset >
                    </fieldset >
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group date">
                        <div class="input-group-addon">
                          ...
                          <input type="text" name="dp" class="form-control field-check-form1" placeholder="DP Pembayaran ... " required>
                      </div>
                    </div>
                  </div>
                  <div class="box-body col-lg-6">
...
<script type="text/javascript">
  ...
  var ruangmakan ="<table border='0' style='margin-bottom:15px;' width='100%' id='dynamicInput'><tr><td width='100%'><label style='margin-top:10px;'>Ruang Makan</label><div class='input-group date'><div class='input-group-addon'><i class='fa fa-plus'></i></div><select onchange='getTarif2()' id='idrumakan' name='ruangpertemuan[]' class='form-control field-check-form1' style='width: 100%;'><option selected='selected' disabled='disabled'>Pilih Ruang Makan</option><?php foreach($kamar_makan as $rowkamar_makan){?><option value='<?=$rowkamar_makan->id_ruangpertemuan?>'><?=$rowkamar_makan->nama_ruang?></option><?php }?></select></div></div></td></tr></table>";

  var pertemuan = "<table border='0' style='margin-bottom:15px;' width='100%' id='dynamicInput2'><tr><td width='85%'><label>Ruang Pertemuan</label><div class='input-group date'><div class='input-group-addon'><i class='fa fa-plus'></i></div><select onchange='getTarif()' name='ruangpertemuan[]' class='form-control field-check-form1 idruangpertemuan' style='width: 100%;'><option selected='selected' disabled='disabled'>Pilih Ruang Pertemuan</option><?php foreach($ruangan_pertemuan as $rowruangan_pertemuan){?><option value='<?=$rowruangan_pertemuan->id_ruangpertemuan?>'><?=$rowruangan_pertemuan->nama_ruang?></option><?php }?></select></div></div></td></tr></table>";

  var additional = "<table border='0' style='margin-bottom:15px;' width='100%' id='dynamicInput2'><tr><td width='85%'><label>Fasilitas Tambahan</label><div class='input-group date'><div class='input-group-addon'><i class='fa fa-plus'></i></div><select id='idadditional' onchange='getTarifF1()' name='fasilitasplus[]' class='form-control field-check-form1' style='width: 100%;'><option selected='selected' disabled='disabled'>Pilih Tambahan Fasilitas</option><?php foreach($jenis_additional as $rowjenis_additional){?><option value='<?=$rowjenis_additional->id_additional?>'><?=$rowjenis_additional->jenis_additional?></option><?php }?></select></div></div></td></tr></table>";

  var counter = 1;
  var counter2 = 1;
  function addInput(divName)
  {
    $.get('/syantikaraweb/api/count/ruang/makan',function(response)
    {
   ...
   {
     $.get('/syantikaraweb/api/count/ruang/pertemuan',function(response)
     {
...
var gender = "";
    ...
    function getTarif() {
      ...
      if(cek == "ya")
      {
        $.get('/syantikaraweb/api/tarif', {id_jenistamu: id_jenistamu, id_jenistarif: id_jenistarif}, function(response)
        {
          var data = JSON.parse(response);
          $.get('/syantikaraweb/api/tarif/ruang/pertemuan?id_ruangpertemuan='+idruangpertemuan, function(response)
          {
    ...
    function getTarifF1() {
      ...
      if(cek == "ya")
      {
        ...
        {
          var data = JSON.parse(response);
              $.get('/syantikaraweb/api/tarif/additional', {id_additional: idadditional}, function(response)
              {
                  var dataadditional = JSON.parse(response);
                  total = total + parseFloat(dataadditional.harga);
                  var rp = toRp(total);
                   $('#total').val(total);
                   $('#total1').val(rp);
                   console.log("ada2");
    ...
    function getTarif2() {
      ...
      var jmlhtamu = $('#jmlhtamu').val();
      var hari = $('#days').val();
      var idruangmakan = $('#idrumakan').val();
      var cek = $('#event-additional').val();
      ...
      if(cek == "ya")
      {
        ...
        {
          var data = JSON.parse(response);
              $.get('/syantikaraweb/api/tarif/ruang/pertemuan?id_ruangpertemuan='+idruangmakan, function(response)
              {
                var datapertemuanmakan = JSON.parse(response);
                total = total + parseFloat(datapertemuanmakan.harga);
                var rp = toRp(total);
                 $('#total').val(total);
                 $('#total1').val(rp);
                 console.log("ada3");
    ...
    function getRuang() {
      ...
      $.get('/syantikaraweb/api/transaksi', function(response) {
      ...
      $.get('/syantikaraweb/api/ruang', {id_ruang: id_ruang}, function(response) {
        var data = JSON.parse(response);
        var idruang = data.id;
        $('#ruang').val(idruang);
      ...
      $.get('/syantikaraweb/api/kamar', {id_ruang: id_ruang}, function(response) {
        var dataka = JSON.parse(response);

          $.get('/syantikaraweb/api/transaksi/room?id_ruang='+id_ruang+'&tgl_checkin=%27'+tgl_checkin+'%27&tgl_checkout=%27'+tgl_checkout+'%27', function(response) {
        ...
        jQuery.each( dataka, function( key, value ){
              ...
              $("#kotakkamar").append("<div class='col-lg-2' style='background:"+bg+"; margin-right:1px; height:110px; margin-bottom:5px; margin-left:25px; border: 2px solid grey;'><p align='center'><label>"+ value.nama_kamar+"</label><br><button type='button' onclick='getKamar("+ value.id_kamar+")' id='id_kamar' style='margin-top:25px;' class='btn btn-sm' > <i class='glyphicon glyphicon-plus'></i>&nbsp; </button> <button type='button' onclick='getDetailKamar("+ value.id_kamar+")' style='margin-top:25px;' class='btn btn-sm' data-toggle='modal' data-target='.bs-example-modal-sm'> <i class='glyphicon glyphicon-list'></i>&nbsp; </button></p></div>");
            });
        });
      });
    }
    ...
    function getDetailKamar($idKamar) {
      ...
      $.get('/syantikaraweb/api/transaksi/room/detil?id_ruang='+id_ruang+'&id_kamar='+id_kamar+'&tgl_checkin=%27'+tgl_checkin+'%27&tgl_checkout=%27'+tgl_checkout+'%27', function(response) {
    ...
    function getKamar($idKamar) {
      ...
      $.get('/syantikaraweb/api/transaksi/total?transaksi_id='+trxid+'&tgl_checkin=%27'+tgl_checkin+'%27&tgl_checkout=%27'+tgl_checkout+'%27', function(response) {
    ...
    jQuery(document).ready(function($){
      $('#MyForm1').on('submit',function(e)
      {
        ...
        var kalimat = "Warning ! Yang Menginap Di Kamar Ini Adalah : " + gender;

        if(jenisgender1 != gender)
        {
          alert(kalimat);
          return false;
        }
