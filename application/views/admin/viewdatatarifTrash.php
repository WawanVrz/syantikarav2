<?php include "Header.php"; ?>
        ...
        <section class="col-lg-12">
          ...
          <div class="box box-primary">
            <div class="box-header">
              ...
              <h3 class="box-title">Master Data Tarif In Bin</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr id="row-<?= $t->id_tarif ?>">
                  ...
                  <td align="center">
                    <button class="btn btn-warning btn-sm" onClick="RestoreData(<?= $t->id_tarif ?>)"><i class="glyphicon glyphicon-repeat"></i>&nbsp; Restore</button>
                    <button class="btn btn-danger btn-sm" onClick="deleteData(<?= $t->id_tarif ?>)"><i class="glyphicon glyphicon-remove"></i>&nbsp; Delete</button>
                  </td>
                </tr>
                <?php } ?>
                </tbody>
  ...
  <script>
    function deleteData(id) {
        ...
        function() {
            $.get('<?php echo base_url('TarifController/hapus/'); ?>', {id:id}, function(data) {
              if (data == 'succeed') {
                  $('#row-' + id).remove();
  ...
  <script>
    function RestoreData(id) {
        ...
        function() {
            $.get('<?php echo base_url('TarifController/restoredelete/'); ?>', {id:id}, function(data) {
              if (data == 'succeed') {
                  $('#row-' + id).remove();
